...
const clients =  [
    ...
    {id:1,name:"Soumen Raj",img:client1,info:"Thank you for your excellent service. Thank you to Ms. Kai and her team who are so helpful and loyal about their service. They always answered all our questions and concern at all hours without getting annoyed."},
...
const Clients = () => {
    return (
        <div >
            <h1 className='clients-title'>Our Successful Clients </h1>
